var Atom = (function(name){
	...
	/*
	this.drawDirectionAtom = (function(){
		switch (this.name)
		{
					case "hydrogen":
					// Fist eletron orbit
					...
					graphics.ctx.restore();
					// Fist eletron orbit
					graphics.drawGirth(this.x,this.y, 102.5, "#5D5D5D");
					// Second eletron orbit
					graphics.drawGirth(this.x,this.y, 145, "#5D5D5D");
					// Neutrons
					graphics.drawCicle(this.x - 10, this.y, this.r + 10, "#CC0000");
					graphics.drawCicle(this.x + 10, this.y, this.r + 10, "#CC0000");
					// Protons
					graphics.drawCicle(this.x, this.y - 10, this.r + 10, "#000099");
					graphics.drawCicle(this.x, this.y + 10, this.r + 10, "#000099");
					// Eltrons velocity
					this.eletronAngle += 10;
					// Fist eletron
					...
					graphics.ctx.translate(this.x, this.y);
					graphics.ctx.rotate(this.eletronAngle * Math.PI / 100); // 90 + widht of quadrate?
					graphics.drawCicle(30 + 40, 30 + 40, 5 + 10, "#00CC00");
					graphics.ctx.restore();
					// second eletron
					graphics.ctx.save();
					graphics.ctx.translate(this.x, this.y);
					graphics.ctx.rotate(this.eletronAngle * Math.PI / 180); // 90 + widht of quadrate?
					graphics.drawCicle(40 + 40, 40 + 80, 5 + 10, "#00CC00");
					graphics.ctx.restore();
					break;
					case "lithium":
					// Atom background
